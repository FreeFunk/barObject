...
public class MappingJackson2JsonView extends AbstractJackson2View {
	...
	protected Object filterModel(Map<String, Object> model) {
		...
		while(arg3.hasNext()) {
			...
			if (!(entry.getValue() instanceof BindingResult) && modelKeys.contains(entry.getKey()) && !((String)entry.getKey()).equals(JsonView.class.getName())) {
	...
	protected void writeContent(OutputStream stream, Object object) throws IOException {
		if (object != null && object instanceof Map) {
			...
			String modelAndViewData = (String)map.get("modelAndViewData");
			if (modelAndViewData != null && modelAndViewData.equals("1")) {
