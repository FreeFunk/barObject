...
@TableName("sys_meun_user")
public class SysMeunUser implements Serializable{
	 ...
	 * 属性描述:菜单ID
	 */
	@TableField(value="MEUN_ID",exist=true)
	java.lang.String meunId;
	...
	public java.lang.String getMeunId(){
		return this.meunId;
	}
	
	public void setMeunId(java.lang.String meunId){
		this.meunId=meunId;
	}
    ...
    public String toString() {
        ...
        sb.append("Hash = ").append(hashCode());
			...
			sb.append(", meunId=").append(meunId);			
    ...
    public boolean equals(Object that) {
        ...
        SysMeunUser other = (SysMeunUser) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getMeunId() == null ? other.getId() == null : this.getMeunId().equals(other.getMeunId()))		
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getId() == null) ? 0 : getId().hashCode());		
		        ...
		        result = prime * result + ((getMeunId() == null) ? 0 : getMeunId().hashCode());		
