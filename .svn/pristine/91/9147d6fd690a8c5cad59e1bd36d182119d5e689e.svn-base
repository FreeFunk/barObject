...
public class UserMoney implements Serializable{
	 ...
	 * 属性描述:余额
	 */
	@TableField(value="USER_MONEY",exist=true)
    ...
    public boolean equals(Object that) {
        ...
        UserMoney other = (UserMoney) that;
        boolean flag = true;
        return  flag
        		&&(this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))		
				        		...
				        		&&(this.getUserMoney() == null ? other.getId() == null : this.getUserMoney().equals(other.getUserMoney()))		
